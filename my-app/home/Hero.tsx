...
const styles = {
  ...
  title:
    "text-4xl sm:text-6xl md:text-[8rem] font-bold tracking-widest text-center",

  subtitle:
    "text-base md:text-2xl font-semibold py-6 md:py-12 tracking-widest px-3 text-center",
