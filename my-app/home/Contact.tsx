...
const styles = {
  ...
  label:
    "block text-sm font-medium text-gray-400 mb-2 tracking-widest uppercase",

  input:
    "w-full border-b border-stone-300 bg-transparent px-0 py-3 text-base focus:outline-none focus:border-[#AE572C] transition",

  textarea:
    "w-full border-b border-stone-300 bg-transparent px-0 py-3 text-base focus:outline-none focus:border-[#AE572C] transition resize-none",
          ...
          <form onSubmit={handleSubmit} className={styles.formGrid}>
            ...
            <div className={styles.fullWidth}>
              <label className={styles.label}>
                Email <span className="text-[#AE572C]">*</span>
              </label>
              <input
                type="email"
                value={form.email}
            ...
            {error && (
              <p className="col-span-1 sm:col-span-2 text-base text-red-500">
                {error}
              </p>
            )}
