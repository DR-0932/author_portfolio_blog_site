...
export default function ExpCardinverted({
  company,
  role,
  description,
  date,
...
const style = {
  ...
  container:
    "w-full md:max-w-[1200px] md:h-[600px] rounded-[40px] overflow-hidden grid grid-cols-[30fr_70fr]  bg-[#EFE7DD] shadow-xl",

  titlebox: "relative flex flex-col py-20 px-16 rounded-[40px] bg-[#FAF6F1] border border-[#E4D6C8] m-1.5",
