...
export default function WorkExperience() {
  ...
  return (
    <div style={{ backgroundColor: bg }}>
      {/* Heading */}
      <div style={{ backgroundColor: bg }}>
        <div className="page-x py-12 md:py-30">
      ...
      <div style={{ backgroundColor: bg }} ref={timelineRef}>
        <div className="page-x relative">
          ...
          <div
            className="hidden md:block absolute top-0 bottom-0 left-[calc(50%-1.5px)] w-0.75 z-0"
            style={{ backgroundColor: trackColor }}
          />
          <motion.div
            className="hidden md:block absolute top-0 left-[calc(50%-1.5px)] w-0.75 z-1"
