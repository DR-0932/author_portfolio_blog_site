...
const styles = {
  wrapper:
    "h-[40%] sm:h-[50%] flex-col sm:flex-row  px-8 py-10 flex w-11/12 rounded-3xl mx-auto relative cursor-pointer ",
  ...
  imageWrapper:
    "w-full sm:w-1/3 rounded-xl aspect-video relative overflow-hidden bg-white/10 flex items-center justify-center",
