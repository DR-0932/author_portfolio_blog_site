...
const styles = {
  ...
  sidebarImage:
    "hidden md:block relative w-full aspect-4/3 overflow-hidden opacity-0 mt-2 [mask-image:radial-gradient(ellipse_80%_80%_at_50%_50%,black_60%,transparent_100%)]",
  ...
  rowService:
    "text-xs md:text-sm tracking-[0.2em] uppercase opacity-60 px-1 md:px-2",
